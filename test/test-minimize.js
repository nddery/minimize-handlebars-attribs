...
var chai = require('chai'),
    ...
    html = require('../node_modules/minimize/test/fixtures/html.json'),
...
describe('Minimize', function () {
  beforeEach(function () {
    minimize = new Minimize({ plugins: [ hbattribs ] });
  });
  ...
  describe('#minifier', function () {
    ...
    it('should be configurable to retain comments', function (done) {
      var commentable = new Minimize({ plugins: [ hbattribs ], comments: true });
    ...
    it('should be able to remove comments but not conditionals', function (done) {
      var eitheror = new Minimize({ plugins: [ hbattribs ], comments: false, conditionals: true });
    ...
    it('should be configurable to retain server side includes', function (done) {
      var commentable = new Minimize({ plugins: [ hbattribs ], ssi: true });
    ...
    it('should be configurable to retain conditional IE comments', function (done) {
      var commentable = new Minimize({ plugins: [ hbattribs ], conditionals: true });
    ...
    it('should be configurable to retain empty attributes', function (done) {
      var empty = new Minimize({ plugins: [ hbattribs ], empty: true });
    ...
    it('should be configurable to retain spare attributes', function (done) {
      var spare = new Minimize({ plugins: [ hbattribs ], spare: true });
    ...
    it('should be configurable to retain whitespace and newlines of attributes', function (done) {
      var whitespace = new Minimize({ plugins: [ hbattribs ], whitespace: true });
    ...
    it('should keep empty attribute values with if empty and spare options are set', function (done) {
      var empty = new Minimize({ plugins: [ hbattribs ], empty: true, spare: true });
    ...
    it('should be configurable to retain CDATA', function (done) {
      var cdata = new Minimize({ plugins: [ hbattribs ], cdata: true });
    ...
    it('should be configurable to retain one whitespace between elements', function (done) {
      var loose = new Minimize({ plugins: [ hbattribs ], loose: true });
    ...
    it('should always quote attributes that end with / regardless of options', function (done) {
      var quote = new Minimize({ plugins: [ hbattribs ], quotes: false });
